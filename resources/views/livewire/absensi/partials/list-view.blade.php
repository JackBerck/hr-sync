            ...
            <div class="flex flex-col sm:flex-row gap-4 flex-1">
                ...
                <div class="min-w-0 flex-1 sm:max-w-xs">
                    <select wire:model.live="filterPegawai"
                        class="block w-full border px-3 py-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm">
                ...
                <div class="min-w-0 flex-1 sm:max-w-xs">
                    <input type="date" wire:model.live="filterTanggal" placeholder="Filter tanggal spesifik"
                        class="block w-full border px-3 py-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm">
                </div>
            </div>
        </div>
        ...
        <div class="p-5">
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        <dt class="text-sm font-medium text-gray-500 truncate">Total Hari Ini</dt>
                        <dd class="text-lg font-medium text-gray-900">{{ $stats['total_hari_ini'] }}</dd>
                    </dl>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="text-lg font-medium text-gray-900">{{ $stats['hadir_hari_ini'] }}</dd>
                    </dl>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm rounded-lg border">
        <div class="p-5">
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        <dt class="text-sm font-medium text-gray-500 truncate">Alpha Hari Ini</dt>
                        <dd class="text-lg font-medium text-gray-900">{{ $stats['alpha_hari_ini'] }}</dd>
                    </dl>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="text-lg font-medium text-gray-900">{{ $stats['total_bulan_ini'] }}</dd>
                    </dl>
                </div>
            </div>
        </div>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-gray-900">{{ $absensi->pegawai->nama }}
                                        </div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-2">
                                    ...
                                    <button wire:click="confirmDelete({{ $absensi->id }})"
    ...
    @else
        ...
        <div class="text-center py-12">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                stroke="currentColor" class="size-12 text-gray-400 mx-auto">
            ...
            <p class="mt-1 text-sm text-gray-500">Mulai dengan menambahkan data absensi.</p>
            <div class="mt-6">
                <button wire:click="openDailyModal"
                    class="inline-flex items-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-lg transition-colors duration-150 mr-3">
