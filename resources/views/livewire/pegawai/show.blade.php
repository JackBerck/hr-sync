                ...
                <div class="bg-white rounded-lg shadow-sm border overflow-hidden">
                    ...
                    <div class="p-6">
                        <dl class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        @if ($pegawai->jabatan)
                                            <span class="text-xs text-gray-500">
                                                Tunjangan: Rp
                                                {{ number_format($pegawai->jabatan->tunjangan, 0, ',', '.') }}
                                            </span>
                                        @endif
                                    </div>
                                </dd>
                            ...
                            <div>
                                <dt class="text-sm font-medium text-gray-500 mb-1">Gaji Pokok</dt>
                                <dd class="text-sm text-gray-900 bg-gray-50 px-3 py-2 rounded-md">
                                    <div class="flex items-center justify-between">
                            ...
                            <div>
                                <dt class="text-sm font-medium text-gray-500 mb-1">Total Gaji (Pokok + Tunjangan)</dt>
                                <dd class="text-sm text-gray-900 bg-gray-50 px-3 py-2 rounded-md">
                                    <div class="flex items-center justify-between">
                                        <span class="text-lg font-semibold text-blue-600">
                                            Rp
                                            {{ number_format($pegawai->gaji + ($pegawai->jabatan->tunjangan ?? 0), 0, ',', '.') }}
                                        </span>
                                        @if ($pegawai->jabatan)
                                            <span class="text-xs text-gray-500">
                                                Termasuk tunjangan
                    ...
                    <div class="p-6">
                        <dl class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            <div>
                                ...
                                <dd class="text-sm text-gray-900 bg-gray-50 px-3 py-2 rounded-md">
                                    <div class="flex flex-col">
                                        <span>{{ $pegawai->created_at->locale('id')->translatedFormat('d F Y') }}</span>
                                        <span
                                            class="text-xs text-gray-500">{{ $pegawai->created_at->format('H:i:s') }}</span>
                                    </div>
                                </dd>
                            </div>
                            <div>
                                ...
                                <dd class="text-sm text-gray-900 bg-gray-50 px-3 py-2 rounded-md">
                                    <div class="flex flex-col">
                                        <span>{{ $pegawai->updated_at->locale('id')->translatedFormat('d F Y') }}</span>
                                        <span
                                            class="text-xs text-gray-500">{{ $pegawai->updated_at->format('H:i:s') }}</span>
                                    </div>
                                </dd>
                            </div>
                        </dl>
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                                ...
                                <div class="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm text-blue-600 break-words">
                                            {{ $pegawai->jabatan->nama_jabatan }}</p>
                            ...
                            @if ($pegawai->unitKerja)
                                <div class="flex items-center justify-between p-4 bg-purple-50 rounded-lg">
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm text-purple-600 break-words">
                                            {{ $pegawai->unitKerja->nama_unit }}</p>
                            ...
                            <div class="flex items-center justify-between p-4 bg-yellow-50 rounded-lg">
                                <div>
                                    <p class="text-sm font-medium text-yellow-900">Total Gaji (Pokok + Tunjangan)</p>
