<div class="min-h-screen py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-gray-600">Kelola data pegawai dalam organisasi</p>
        </div>
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 flex-1">
                        ...
                        <div class="min-w-0 flex-1 sm:max-w-xs">
                            <select wire:model.live="filterJabatan"
                                class="block w-full border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 px-3 py-2 border focus:border-blue-500 text-sm">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ $pegawais->total() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ $jabatans->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg border">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Total Unit Kerja</dt>
                                <dd class="text-lg font-medium text-gray-900">{{ $unitKerjas->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg border">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Hasil Pencarian</dt>
        ...
        <div class="bg-white rounded-lg shadow-sm border overflow-hidden">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                <div class="text-sm font-medium text-gray-900">{{ $pegawai->nama }}
                                                </div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                            {{ $pegawai->jabatan->nama_jabatan ?? '-' }}</div>
                                        @if ($pegawai->jabatan)
                                            <div class="text-sm text-gray-500">Rp
                                                {{ number_format($pegawai->jabatan->tunjangan, 0, ',', '.') }}</div>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $pegawai->unitKerja->nama_unit ?? '-' }}
                                        </div>
                                        @if ($pegawai->unitKerja)
                                            <div class="text-sm text-gray-500">{{ $pegawai->unitKerja->lokasi }}</div>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end space-x-2">
                                            ...
                                            <button wire:click="confirmDelete({{ $pegawai->id }})"
            ...
            @else
                ...
                <div class="text-center py-12">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900">Tidak ada data pegawai</h3>
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 class="text-lg leading-6 font-medium text-gray-900">Hapus Pegawai</h3>
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    Apakah Anda yakin ingin menghapus pegawai ini? Data yang sudah dihapus tidak dapat
                                    dikembalikan.
                                </p>
                            </div>
                        </div>
