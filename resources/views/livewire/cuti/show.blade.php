    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="p-6">
                        <dl class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                ...
                                <dd class="text-sm text-gray-900 bg-gray-50 px-3 py-2 rounded-md">
                                    <div class="flex flex-col">
                                        ...
                                        @if($cuti->pegawai->jabatan)
                                            <span class="text-xs text-gray-500">{{ $cuti->pegawai->jabatan->nama_jabatan }}</span>
                                        @endif
                                        @if($cuti->pegawai->unitKerja)
                                            <span class="text-xs text-gray-500">{{ $cuti->pegawai->unitKerja->nama_unit }}</span>
                                        @endif
                                    </div>
                                </dd>
                            </div>
                            <div>
                                ...
                                <dd class="text-sm text-gray-900 bg-gray-50 px-3 py-2 rounded-md">
                                    <div class="flex flex-col">
                                        <span>{{ $cuti->tanggal_mulai->format('d F Y') }}</span>
                                        <span class="text-xs text-gray-500">{{ $cuti->tanggal_mulai->format('l') }}</span>
                                    </div>
                                </dd>
                            </div>
                            <div>
                                ...
                                <dd class="text-sm text-gray-900 bg-gray-50 px-3 py-2 rounded-md">
                                    <div class="flex flex-col">
                                        <span>{{ $cuti->tanggal_akhir->format('d F Y') }}</span>
                                        <span class="text-xs text-gray-500">{{ $cuti->tanggal_akhir->format('l') }}</span>
                                    </div>
                                </dd>
                            </div>
                            <div>
                                ...
                                <dd class="text-sm text-gray-900 bg-gray-50 px-3 py-2 rounded-md">
                                    <span class="text-lg font-semibold text-blue-600">{{ $cuti->jumlah_hari }} hari</span>
                                </dd>
                            </div>
                            <div>
                    ...
                    <div class="p-6">
                        <dl class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            <div>
                                ...
                                <dd class="text-sm text-gray-900 bg-gray-50 px-3 py-2 rounded-md">
                                    <div class="flex flex-col">
                                        <span>{{ $cuti->created_at->format('d F Y') }}</span>
                                        <span class="text-xs text-gray-500">{{ $cuti->created_at->format('H:i:s') }}</span>
                                    </div>
                                </dd>
                            </div>
                            <div>
                                ...
                                <dd class="text-sm text-gray-900 bg-gray-50 px-3 py-2 rounded-md">
                                    <div class="flex flex-col">
                                        <span>{{ $cuti->updated_at->format('d F Y') }}</span>
                                        <span class="text-xs text-gray-500">{{ $cuti->updated_at->format('H:i:s') }}</span>
                                    </div>
                                </dd>
                            </div>
                        </dl>
            ...
            <div class="lg:col-span-1">
                ...
                <div class="bg-white rounded-lg shadow-sm border overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200">
                        <h2 class="text-lg font-semibold text-gray-900">Statistik Cuti {{ $cuti->tanggal_mulai->year }}</h2>
                    </div>
                    <div class="p-6">
                        <div class="space-y-4">
                            {{-- Total Jatah --}}
                            ...
                            {{-- Sisa Cuti --}}
                            <div class="flex items-center justify-between p-4 {{ $sisaCuti > 0 ? 'bg-green-50' : 'bg-red-50' }} rounded-lg">
                                <div>
                                    <p class="text-sm font-medium {{ $sisaCuti > 0 ? 'text-green-900' : 'text-red-900' }}">Sisa Cuti</p>
                                    <p class="text-2xl font-bold {{ $sisaCuti > 0 ? 'text-green-600' : 'text-red-600' }}">{{ $sisaCuti }} hari</p>
                                </div>
