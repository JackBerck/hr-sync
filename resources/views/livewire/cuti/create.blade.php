                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        @error('tanggal_mulai')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-sm text-gray-500">Tanggal mulai cuti tidak boleh lebih awal dari hari ini
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        @error('tanggal_akhir')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-sm text-gray-500">Tanggal akhir tidak boleh lebih awal dari tanggal mulai
                        </p>
                    </div>
