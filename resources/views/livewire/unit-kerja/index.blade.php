{{-- filepath: c:\laragon\www\hr-sync\resources\views\livewire\unit-kerja\index.blade.php --}}
<div class="min-h-screen py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {{-- Header --}}
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Data Unit Kerja</h1>
            <p class="mt-2 text-gray-600">Kelola data unit kerja dalam organisasi</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border mb-6">
            <div class="p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="relative flex-1 max-w-md">
                    ...
                    <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cari unit kerja..."
                ...
                {{-- Add Button --}}
                <a wire:navigate href="{{ route('unit-kerja.create') }}"
        ...
        <div class="bg-white rounded-lg shadow-sm border overflow-hidden">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            ...
                                            {{ $unitKerja->pegawais_count ?? 0 }} orang
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end space-x-2">
                                            ...
                                            <button wire:click="confirmDelete({{ $unitKerja->id }})"
            ...
            @else
                ...
                <div class="text-center py-12">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900">Tidak ada data unit kerja</h3>
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 class="text-lg leading-6 font-medium text-gray-900">Hapus Unit Kerja</h3>
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    Apakah Anda yakin ingin menghapus unit kerja ini? Data yang sudah dihapus tidak dapat
                                    dikembalikan.
                                </p>
                            </div>
                        </div>
