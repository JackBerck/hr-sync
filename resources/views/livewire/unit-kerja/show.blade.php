                            ...
                            <div>
                                ...
                                <dd class="text-sm text-gray-900 bg-gray-50 px-3 py-2 rounded-md">
                                    <div class="flex flex-col">
                                        <span>{{ $unitKerja->created_at->locale('id')->translatedFormat('d F Y') }}</span>
                                        <span
                                            class="text-xs text-gray-500">{{ $unitKerja->created_at->format('H:i:s') }}</span>
                                    </div>
                                </dd>
                            </div>
                            <div>
                                ...
                                <dd class="text-sm text-gray-900 bg-gray-50 px-3 py-2 rounded-md">
                                    <div class="flex flex-col">
                                        <span>{{ $unitKerja->updated_at->locale('id')->translatedFormat('d F Y') }}</span>
                                        <span
                                            class="text-xs text-gray-500">{{ $unitKerja->updated_at->format('H:i:s') }}</span>
                                    </div>
                                </dd>
                            </div>
                            @if ($unitKerja->deleted_at)
                                <div>
                                    ...
                                    <dd
                                        ...
                                        <div class="flex flex-col">
                                            <span
                                                class="text-red-700">{{ $unitKerja->deleted_at->locale('id')->translatedFormat('d F Y') }}</span>
                                            <span
                                                class="text-xs text-red-500">{{ $unitKerja->deleted_at->format('H:i:s') }}</span>
                                        </div>
                                    </dd>
                                </div>
                            @endif
