<div class="min-h-screen py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-gray-600">Kelola data jabatan dalam organisasi</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border mb-6">
            <div class="p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                {{-- Add Button --}}
                <a wire:navigate href="{{ route('jabatan.create') }}"
        ...
        <div class="bg-white rounded-lg shadow-sm border overflow-hidden">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            ...
                                            {{ $jabatan->pegawais_count ?? 0 }} orang
                                        </span>
                                    </td>
            ...
            @else
                ...
                <div class="text-center py-12">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900">Tidak ada data jabatan</h3>
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 class="text-lg leading-6 font-medium text-gray-900">Hapus Jabatan</h3>
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    Apakah Anda yakin ingin menghapus jabatan ini? Data yang sudah dihapus tidak dapat
                                    dikembalikan.
                                </p>
                            </div>
                        </div>
